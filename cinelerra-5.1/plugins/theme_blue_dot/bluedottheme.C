...
Theme* BlueDotThemeMain::new_theme()
{
	...
	extern unsigned char _binary_theme_blue_dot_data_start[];
...
// CWindow
	new_image("cpanel_bg.png");
	new_image("cbuttons_left.png");
	new_image("cbuttons_right.png");
	new_image("cmeter_bg.png");

// VWindow
	new_image("vbuttons_left.png");
	new_image("vbuttons_right.png");
