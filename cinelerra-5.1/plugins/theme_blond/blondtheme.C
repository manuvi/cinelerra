...
Theme* BlondThemeMain::new_theme()
{
	...
	extern unsigned char _binary_theme_blond_data_start[];
	theme->set_data(_binary_theme_blond_data_start);
	return theme;
}
...
void BlondTheme::initialize()
{
	...
	resources->listbox_inactive = 0xcecea2;
