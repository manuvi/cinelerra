...
UNFLATTHEMEMain::UNFLATTHEMEMain(PluginServer *server)
 : PluginTClient(server)
{
}

UNFLATTHEMEMain::~UNFLATTHEMEMain()
{
}
...
{
	theme = new UNFLATTHEME;
	extern unsigned char _binary_theme_unflat_data_start[];
...
void UNFLATTHEME::build_bg_data()
{
// Audio settings
...
void UNFLATTHEME::draw_cwindow_bg(CWindowGUI *gui)
{
...
void UNFLATTHEME::draw_vwindow_bg(VWindowGUI *gui)
{
...
void UNFLATTHEME::draw_preferences_bg(PreferencesWindow *gui)
{
	gui->draw_vframe(get_image("preferences_bg"), 0, 0);
}

void UNFLATTHEME::draw_new_bg(NewWindow *gui)
{
	gui->draw_vframe(get_image("new_bg"), 0, 0);
}

void UNFLATTHEME::draw_setformat_bg(SetFormatWindow *gui)
{
