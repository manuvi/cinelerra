...
{
	return new PINKLADYMain(server);
}

PINKLADYMain::PINKLADYMain(PluginServer *server)
 : PluginTClient(server)
{
}

PINKLADYMain::~PINKLADYMain()
{
}
...
{
	theme = new PINKLADY;
	extern unsigned char _binary_theme_pinklady_data_start[];
	theme->set_data(_binary_theme_pinklady_data_start);
	return theme;
}
...
void PINKLADY::initialize()
{
	...
	resources->bg_color = 0xd46a95;
	resources->border_light2 = resources->bg_color;
	resources->border_shadow2 = resources->bg_color;
	resources->default_text_color = 0x1b0f11;
	resources->menu_title_text = 0x1b0f11;
	resources->popup_title_text = 0x1b0f11;
	resources->menu_item_text = 0x1b0f11;
...
void PINKLADY::draw_rwindow_bg(RecordGUI *gui)
{
// 	int y;
// 	int margin = xS(50);
// 	int margin2 = xS(80);
...
void PINKLADY::draw_rmonitor_bg(RecordMonitorGUI *gui)
{
// 	int margin = xS(45);
// 	int panel_w = xS(300);
...
void PINKLADY::draw_cwindow_bg(CWindowGUI *gui)
{
...
void PINKLADY::draw_vwindow_bg(VWindowGUI *gui)
{
...
void PINKLADY::draw_preferences_bg(PreferencesWindow *gui)
{
	gui->draw_vframe(get_image("preferences_bg"), 0, 0);
}

void PINKLADY::draw_new_bg(NewWindow *gui)
{
	gui->draw_vframe(get_image("new_bg"), 0, 0);
}

void PINKLADY::draw_setformat_bg(SetFormatWindow *gui)
{
