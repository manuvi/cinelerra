...
Theme* BlueDotThemeMain::new_theme()
{
	...
	extern unsigned char _binary_theme_blue_data_start[];
	theme->set_data(_binary_theme_blue_data_start);
	return theme;
}
...
void BlueDotTheme::initialize()
{
	...
	resources->bg_color = 0x939ed4;
	resources->border_light2 = resources->bg_color;
	resources->border_shadow2 = resources->bg_color;
	resources->default_text_color = 0xeeeeff;
	resources->menu_title_text = 0xeeeeff;
	resources->popup_title_text = 0xeeeeff;
	resources->menu_item_text = 0xeeeeff;
