...
BlondCVThemeMain::~BlondCVThemeMain()
{
}
...
{
	theme = new BlondCVTheme;
	extern unsigned char _binary_theme_blond_cv_data_start[];
...
void BlondCVTheme::get_cwindow_sizes(CWindowGUI *gui, int cwindow_controls)
{
	if(cwindow_controls)
	{
		ccomposite_x = 0;
...
void BlondCVTheme::build_bg_data()
{
// Audio settings
...
void BlondCVTheme::get_preferences_sizes()
{
}


void BlondCVTheme::draw_preferences_bg(PreferencesWindow *gui)
{
	gui->draw_vframe(get_image("preferences_bg"), 0, 0);
}

void BlondCVTheme::get_new_sizes(NewWindow *gui)
{
}

void BlondCVTheme::draw_new_bg(NewWindow *gui)
{
	gui->draw_vframe(get_image("new_bg"), 0, 0);
}

void BlondCVTheme::draw_setformat_bg(SetFormatWindow *gui)
{
